...
export function mountHealth(box, slug, { onRecipeChanged }) {
  async function reload() {
    ...
    if (versions.length) {
      ...
      const rows = versions.map((b, i) => el("tr", {},
        ...
        el("td", { class: "muted inline" }, day(b.date)),
        el("td", { class: "num inline", "data-label": "runs" }, String(b.runs)),
        el("td", {}, outcomes(b),
        ...
        el("td", { class: "num inline", "data-label": "med. turns" }, b.runs ? fmtNum(b.turns_median) : "—"),
        el("td", { class: "num inline", "data-label": "med. tokens" }, b.runs ? fmtNum(b.tokens_median) : "—"),
        el("td", { class: "num inline", "data-label": "asks", title: "decisions deferred to you during these runs" }, b.asks_deferred ? String(b.asks_deferred) : "—"),
  ...
  function cautionSections(c) {
    ...
    if (reminders.length) {
      ...
      out.push(el("div", { class: "tablewrap" }, el("table", { class: "list stack" },
    ...
    if (assists.length) {
      out.push(el("div", { class: "muted small mt" }, "rule assists that have fired"),
        el("div", { class: "tablewrap" }, el("table", { class: "list stack" },
