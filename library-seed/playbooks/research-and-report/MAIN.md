...
2. Search the web, then fetch the promising pages, to gather sources for each sub-question — your
   catalog has a tool for each. Prefer primary/authoritative sources and note each source's date.
