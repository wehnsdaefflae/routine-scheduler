...
1. **Heal broken instructions — now, not deferred.** A contradiction or stale rule in
   main.md or a steps/ module: edit the smallest responsible file directly. Fix the
...
3. **R&D, two tracks.**
   ...
   - *Track 2 (process):* revise the smallest steps/ or main.md module that underperformed;
...
your own steps/ or main.md files, restructuring your own outputs, committing. **Proposal-only**
