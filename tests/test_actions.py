...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"say": "s", "kind": "script", "name": "poll-inbox", "args": ["--json"]},
        ...
        {"say": "s", "kind": "manage_lane", "verb": "create", "name": "Morning jobs",
        ...
        {"say": "s", "kind": "report", "title": "schedule_run ate my args",
         "detail": "called X, got Y, expected Z", "target": "self-audit", "answers": "R3"},
        {"say": "s", "kind": "delete", "path": "state/stale-cache/", "recursive": True},
        {"say": "s", "kind": "move", "src": "artifacts/draft.md", "dst": "state/final/draft.md"},
        {"say": "s", "kind": "mkdir", "path": "state/weekly-digests", "parents": True},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"say": "s", "kind": "shell", "command": "ls", "name": "shell"}, "do not belong"),
