...
The curated rules below `git-checkpoint` in the shipped set
([rules & permissions](rules-permissions.md)) are distilled from external prompt-engineering
